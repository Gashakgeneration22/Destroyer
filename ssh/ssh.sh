...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/Gashakgeneration22/Destroyer/main/ssh"
#
# initializing var
...
wget -qO- -O /etc/ssh/sshd_config https://raw.githubusercontent.com/Gashakgeneration22/Destroyer/main/sshd_config
...
# Ganti Banner
wget -O /etc/issue.net "https://raw.githubusercontent.com/Gashakgeneration22/Destroyer/main/ssh/issue.net"
/etc/init.d/ssh restart
/etc/init.d/dropbear restart
