...
echo -e "\E[44;1;39m            ⇱ XRAY DESTROYER Multi All Port ⇲             \E[0m" | tee -a /etc/log-create-user.log
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}" | tee -a /etc/log-create-user.log
...
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-user.log
echo -e "SCRIPT DESTROYER by Joesatria22" | tee -a /etc/log-create-user.log
